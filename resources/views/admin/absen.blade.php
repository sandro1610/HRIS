...
@section('content')
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <!-- MULAI TOMBOL TAMBAH -->
                <a href="javascript:void(0)" class="btn btn-info" id="tombol-tambah">Tambah Absen</a>
                &nbsp;
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control border border-dark" id="periode" name="periode" value="" required>
                                    </div>
                                  </div>
                                  <div class="form-row">
                                    <div class="form-group col-md-4">
                                        <label for="shift1">Shift Pagi</label>
                                        <input type="text" class="form-control border border-dark" id="shift1" name="shift1" value="" required>
                                    </div>
                                    <div class="form-group col-md-4">
                                      <label for="shift2">Shift Malam</label>
                                      <input type="text" class="form-control border border-dark" id="shift2" name="shift2" value="" required>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="stb">STB</label>
                                        <input type="text" class="form-control border border-dark" id="stb" name="stb" value="" required>
                                    </div>
                                  </div>
                                  <div class="form-row">
                                    <div class="form-group col-md-4">
                                      <label for="tr">TR</label>
                                      <input type="text" class="form-control border border-dark" id="tr" name="tr" value="" required>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="telat">Telat</label>
                                        <input type="text" class="form-control border border-dark" id="telat" name="telat" value="" required>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="jumlah_lembur">Jumlah Lembur</label>
                                        <input type="text" class="form-control border border-dark" id="jumlah_lembur" name="jumlah_lembur" value="" required>
                                    </div>
                                  </div>
                                </div>
